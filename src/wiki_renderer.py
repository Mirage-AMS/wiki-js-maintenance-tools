...
class WikiPTLRenderer(WikiRenderer):
    ...
    IMAGE_DICT = {
        ...
        # 任意消耗
        "eE0X": ("/rule/rule_basic/rule_element", "#h-2-元素种类", "地之元素"),
        "eW0X": ("/rule/rule_basic/rule_element", "#h-2-元素种类", "水之元素"),
        "eF0X": ("/rule/rule_basic/rule_element", "#h-2-元素种类", "火之元素"),
        "eA0X": ("/rule/rule_basic/rule_element", "#h-2-元素种类", "风之元素"),
        "eC0X": ("/rule/rule_basic/rule_element", "#h-2-元素种类", "万用元素"),
        "eR0X": ("/rule/rule_basic/rule_element", "#h-2-元素种类", "无色元素"),
        # 特殊元素
        "eB01": ("/card/role/card_rol03_ri_01", '', "血之元素"),
        "eL01": ("/card/role/card_rol03_ri_05", '', "圣之元素"),
        # 传奇点专用
