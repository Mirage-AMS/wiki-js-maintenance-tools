...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function performSearch(query) {
    ...
    // 这里应该替换为实际的Wiki.js API调用
    // 模拟搜索结果 - 实际应用中应替换为真实API请求
    setTimeout(() => {
      // 模拟从Wiki.js获取数据
      ...
      const mockResults = [
        {
          ...
          snippet: `这是关于 ${query} 卡牌的详细介绍，包括其属性、技能和使用方法。${query} 是一套非常强大的卡牌组合中的核心卡片。`,
          properties: {
            "属性": "火",
            "稀有度": "SSR",
            "攻击力": "9500"
        ...
        },
        {
          ...
          snippet: `本文介绍了 ${query} 卡牌的多种获取途径，包括商店购买、任务奖励和活动兑换等方式。`,
          properties: {
            "获取难度": "中等",
            "推荐指数": "★★★★☆"
          }
        },
        {
          ...
          snippet: `探索 ${query} 卡牌与其他卡牌的最佳组合方式，提升你的战斗效率和胜率。`,
          properties: {
            "最佳搭档": "水之精灵",
            "战术定位": "主攻"
          }
